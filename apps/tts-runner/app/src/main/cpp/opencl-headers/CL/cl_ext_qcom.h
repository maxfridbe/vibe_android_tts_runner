...
typedef cl_mem(CL_API_CALL *clCreateBufferFromImageQCOM_fn)(cl_mem image, cl_mem_flags flags, cl_int *errcode_ret);
...
extern CL_API_ENTRY cl_recording_qcom CL_API_CALL clNewRecordingQCOM(cl_command_queue, cl_int *);
extern CL_API_ENTRY cl_int CL_API_CALL clEndRecordingQCOM(cl_recording_qcom);
extern CL_API_ENTRY cl_int CL_API_CALL clReleaseRecordingQCOM(cl_recording_qcom);
extern CL_API_ENTRY cl_int CL_API_CALL clRetainRecordingQCOM(cl_recording_qcom);
...
typedef cl_int(CL_API_CALL *clRetainRecordingQCOM_fn)(cl_recording_qcom);

extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueRecordingQCOM(
    cl_command_queue /** command_queue */, cl_recording_qcom /** recording */,

    size_t /** number of recorded args being updated */, const cl_array_arg_qcom * /** recorded arg to update */,

    size_t /** Number of global offsets to update */, const cl_offset_qcom * /** Array  offsets to update */,

    size_t /** number of global workgroups being updated */, const cl_workgroup_qcom * /** global work group array */,

    size_t /** number of local workgroups being updated */, const cl_workgroup_qcom * /** local work size array */,
...
extern CL_API_ENTRY cl_int CL_API_CALL clEnqueueRecordingSVMQCOM(
    cl_command_queue /** command_queue */, cl_recording_qcom /** recording */,
...
typedef cl_int(CL_API_CALL *clEnqueueRecordingSVMQCOM_fn)(
    cl_command_queue /** command_queue */, cl_recording_qcom /** recording */,
...
extern CL_API_ENTRY cl_int CL_API_CALL clQueryImageInfoQCOM(
    cl_device_id device, cl_mem_flags flags, const cl_image_format *image_format, const cl_image_desc *image_desc,
    cl_extended_image_info_qcom param_name, size_t param_value_size, void *param_value, size_t *param_value_size_ret);

typedef cl_int(CL_API_CALL *clQueryImageInfoQCOM_fn)(cl_device_id device, cl_mem_flags flags,
...
#define CL_EXTERNAL_MEMORY_HANDLE_VULKAN_OPAQUE_FD_QCOM 0x41A8

/*******************************************
 * cl_qcom_ahardwarebuffer_direct_import *
 *******************************************/

#define CL_IMAGE_IMPORT_AHB_DIRECT_QCOM 0x41A5
