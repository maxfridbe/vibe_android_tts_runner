...
object AudioShare {
    ...
    /** Convert a 24 kHz mono s16 WAV (our own output format) to m4a in the
     *  share cache and hand it to the chooser. Blocking; call off-main. */
    fun shareWavAsM4a(ctx: Context, wav: File, title: String) {
        ...
        val enc = AacM4aWriter(pfd, 24000)
